...
Compared to the original [provider](https://github.com/pablovarela/terraform-provider-slack) this version contains various improvements:
- Built around the terraform plugin framework
- Added rate limit handling for all Slack API endpoints
- Better handling of conflicts with existing usergroups
- Updated slack-go library to the latest version
